...
def merge_files(source_folder, destination_folder, files_per_merge=4):
    ...
    for i in range(0, len(source_files), files_per_merge):
        # Mengambil 4 file dengan urutan yang diinginkan
        files_to_merge = source_files[i:i+files_per_merge]

        # Membaca isi dari 4 file tersebut
        file_contents = []
        ...
        # Menyimpan hasil gabungan ke dalam file baru dengan format kolom
